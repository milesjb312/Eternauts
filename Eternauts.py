...
import pygame
from pygame.locals import VIDEORESIZE, K_UP, K_DOWN, K_LEFT, K_RIGHT, K_ESCAPE, KEYDOWN, QUIT, K_c, K_h, K_p, K_r, K_s, K_t, K_LSHIFT
...
while running:
    ...
    for event in pygame.event.get():
        if event.type == KEYDOWN:
            ...
            #elif event.key == K_p:
            #    if (cwod) in chunks.chunk_book:
            #        print(f'chunk_book[cwod]: {chunks.chunk_book[cwod]}')
